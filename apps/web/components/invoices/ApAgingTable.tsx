...
/** Vendor payables split into ageing buckets — the classic AP-ageing report. */
    ...
    return (
      <div className="card overflow-hidden">
        <EmptyState
          ...
          description="Every approved invoice is fully paid — no payables are ageing right now."
        />
      </div>
    );
  }
    ...
    <div className="card overflow-hidden">
      <div className="overflow-x-auto">
        <table className="w-full text-sm">
          ...
          <tbody>
            {data.rows.map((r) => (
              <tr key={r.vendorId} className="border-t border-border">
          ...
          <tfoot>
            <tr className="border-t-2 border-border bg-surface font-semibold">
              <td className="px-4 py-3">All vendors</td>
